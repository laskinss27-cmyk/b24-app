...
export interface B24Context {
	...
	taskId?: number | null;
	/** Заявка ТТ, которую нужно открыть из задачи. */
	requestId?: number | null;
	/** Перемещение, которое нужно открыть сразу (переход из сообщения складского чата). */
	transferId?: number | null;
	/** Сделка, чью заявку снабжению нужно раскрыть. */
	dealSupplyId?: number | null;
	/** Автор заявки/задачи для однозначного выбора экрана у пользователей с несколькими ролями. */
