...
const ROUTE_PERMISSIONS: Readonly<Record<string, readonly AccessPermissionId[]>> = {
	...
	'/api/operation-log/list': ['realizations.view'],
	...
	'/api/stock/assortment-matrix/templates': ['supply.view'],
	'/api/stock/assortment-matrix/templates/save': ['supply.view'],
	'/api/stock/assortment-matrix/templates/delete': ['supply.view'],
