...
const seedPath = fileURLToPath(new URL('../../migrations/data/tilda-product-mappings-2026-09-03.csv', import.meta.url));
...
try {
	...
	console.log(`Tilda 2026-09-03 mapping backfill complete: ${JSON.stringify(result)}`);
} finally {
