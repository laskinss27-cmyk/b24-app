...
test('application SQL migrations are ordered and use narrowly scoped DDL', async () => {
	...
	assert.deepEqual(migrations.map((migration) => migration.filename), [
		...
		'0084_create_app_state_heads.sql',
		'0085_create_app_state_revisions.sql',
		'0086_create_app_state_checkpoints.sql',
		'0087_create_app_log_identities.sql',
		'0088_create_app_contract_commands.sql',
		'0089_create_app_contract_files.sql',
		'0090_create_app_matrix_templates.sql',
		'0091_create_app_matrix_creators.sql',
		'0092_create_app_matrix_editors.sql',
		'0093_create_app_matrix_stores.sql',
		'0094_create_app_matrix_rows.sql',
		'0095_create_app_saved_reports.sql',
		'0096_create_app_report_definitions.sql',
		'0097_create_app_report_columns.sql',
		'0098_create_app_report_groups.sql',
		'0099_create_app_report_filters.sql',
		'0100_create_app_report_categories.sql',
		'0101_create_app_report_sort.sql',
		'0102_create_app_contract_documents.sql',
		'0103_create_app_contract_sequences.sql',
		'0104_create_app_legacy_realizations.sql',
		'0105_create_app_realization_stores.sql',
		'0106_create_app_operation_events.sql',
		'0107_create_app_operation_actors.sql',
		'0108_create_app_operation_deals.sql',
		'0109_create_app_operation_documents.sql',
	...
	for (const migration of migrations.slice(37, 43)) {
	...
	const expandedCatalogLabel = migrations[43]!.sql;
	assert.match(expandedCatalogLabel, /^ALTER TABLE catalog_mirror_attributes\b/);
