CREATE TABLE app_matrix_rows (
  ...
  f_product_id DOUBLE NOT NULL,
  f_category LONGTEXT NOT NULL,
  f_segment LONGTEXT NOT NULL,
  f_to_order_qty DOUBLE NOT NULL,
  f_comment LONGTEXT NOT NULL,
  ...
  FOREIGN KEY (snapshot_id,parent_no) REFERENCES app_matrix_templates(snapshot_id,node_no)
